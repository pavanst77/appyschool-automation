...
public class TestSuiteSetup extends SoftAssertionBase {
	 ...
	 * @throws JSONException
	 */
	@Test(dataProviderClass = com.appyschool.common.CommonUtils.class, dataProvider = "getDataFromFile", dependsOnMethods = {"testCreateBranch", "testCreateStandards", "testCreateSections"})
	...
	public void testMapBranchStandardSection(HashMap<String, String> map) throws JSONException {
		...
		for (int kk = 0; kk < responseObj.length(); kk ++) {
			SuiteSetupProperties.setValue("MAP_BRANCH_STANDARD_SECTION_" + (kk + 1), responseObj.getJSONObject(kk).get("id"));
		}
	}
	...
	public void testCreateStudents(HashMap<String, String> map) throws JSONException {
		...
		Map<String, String> branchStandardIds = CommonMethods.getBranchStandardFromMapBranchStandardSections(SuiteSetupProperties.getValue("BRANCH_ID_1"));
		
		map.put("$branchId", SuiteSetupProperties.getValue("BRANCH_ID_1"));
